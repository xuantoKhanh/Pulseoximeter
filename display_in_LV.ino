...
#define FIREBASE_HOST "displayinlistview-default-rtdb.firebaseio.com"
#define FIREBASE_AUTH "Amspg4V4PKIxldTZgaUpAoR0Rfud3Q3drpVuEyc3"
...
//
//// }}else {
////  Serial.println("Cannot find your finger!");
////        oled.clearDisplay();
////        oled.setTextSize(1.5);
////        oled.setTextColor(1);
////        oled.setCursor(0, 45);
////        oled.println("Cannot find your finger!");
////        oled.display();
////}
//
//}
...
float SpO2 =pox.getSpO2();
  ...
  Serial.print(bpm);
  String fireHR = String(bpm) + String("bpm");
  ...
  Firebase.setString("/Storing/HR", fireHR);
  Firebase.setString("/Storing/HR", fireSpO2);
    Firebase.setString("/Storing/HR", fbtime);
  Firebase.pushString("/Storing", "HeartRate: " + fireHR + " " + "| " + "SpO2: " + fireSpO2 + "\n" + fbtime + " " + fbdate);
